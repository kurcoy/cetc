...
int  des_encode(CRYPTO_TYPE type, const unsigned char key[], unsigned char keyLen, const unsigned char vi[8], const unsigned char in[],unsigned char **out,int *len){
...
int  des_decode(CRYPTO_TYPE type, const unsigned char key[], unsigned char keyLen, const unsigned char vi[8], const unsigned char in[],unsigned char **out,int *len){
...
int  md5(MD5_RESULT_TYPE type, const unsigned char in[],unsigned char **out,int *len){
...
int  base64_en(const unsigned char in[],unsigned char **out,int *len){
...
int  base64_de(const unsigned char in[],unsigned char **out,int *len){
...
int main() {
	...
	printf("=====================DES ECB==================\n");
	len = 8;
	if(des_encode(DES_ECB,"12345678",8,NULL,"12345678",&res,&len) == 0){
		printf("DES ECB ENCODE:");
		printHex(res,len);
		if(des_decode(DES_ECB,"12345678",8,NULL,res,&res2,&len) == 0){
	...
	printf("=====================DES CBC==================\n");
	len = 8;
	if(des_encode(DES_CBC,"12345678",8,"12345678","12345678",&res,&len) == 0){
		printf("DES CBC ENCODE:");
		printHex(res,len);
		if(des_decode(DES_CBC,"12345678",8,"12345678",res,&res2,&len) == 0){
	...
	printf("=====================3DES ECB==================\n");
	len = 10;
	if(des_encode(DES3_ECB,"1234567812345678",16,NULL,"1234567890",&res,&len) == 0){
		printf("3DES ECB ENCODE:");
		printHex(res,len);
		if(des_decode(DES3_ECB,"1234567812345678",16,NULL,res,&res2,&len) == 0){
	...
	printf("=====================3DES CBC==================\n");
	len = 10;
	if(des_encode(DES3_CBC,"1234567812345678",16,"12345678","1234567890",&res,&len) == 0){
		printf("3DES CBC ENCODE:");
		printHex(res,len);
		if(des_decode(DES3_CBC,"1234567812345678",16,"12345678",res,&res2,&len) == 0){
